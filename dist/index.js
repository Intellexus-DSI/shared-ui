...
const NavBar = ({ logoutComponent, items, navigate }) => {
    ...
    return (jsxRuntimeExports.jsx(reactBootstrap.Navbar, { expand: "lg", sticky: "top", className: "navbar", expanded: !isCollapsed, onToggle: () => setIsCollapsed(!isCollapsed), children: jsxRuntimeExports.jsxs(reactBootstrap.Container, { children: [jsxRuntimeExports.jsxs("div", { className: "d-flex justify-content-between align-items-center w-100", children: [jsxRuntimeExports.jsx(reactBootstrap.Navbar.Brand, { onClick: () => handleNavigate("/"), style: { cursor: "pointer" }, children: jsxRuntimeExports.jsx("div", { className: "nav-logo d-flex align-items-center", children: jsxRuntimeExports.jsx("img", { src: IntellexusLogo, alt: "Intellexus Logo", className: "nav-logo-img" }) }) }), jsxRuntimeExports.jsx(reactBootstrap.Navbar.Toggle, { className: "nav-toggle", "aria-controls": "basic-navbar-nav" })] }), jsxRuntimeExports.jsx(reactBootstrap.Navbar.Collapse, { id: "basic-navbar-nav", children: jsxRuntimeExports.jsx(reactBootstrap.Nav, { className: "ms-auto nav-links", children: items.map((item, index) => {
                            if (item.type === 'dropdown' && item.items) {
                                return (jsxRuntimeExports.jsx(reactBootstrap.NavDropdown, { title: item.title, id: `${item.title.toLowerCase()}-dropdown`, className: "nav-item centered-dropdown", show: dropdownStates[item.title] || false, onMouseEnter: () => handleMouseEnter(item.title), onMouseLeave: () => handleMouseLeave(item.title), children: item.items.map((subItem, subIndex) => (jsxRuntimeExports.jsx(reactBootstrap.NavDropdown.Item, { onClick: () => handleNavigate(subItem.path), children: subItem.title }, subIndex))) }, index));
                            }
                            else if (item.type === 'link' && item.path) {
                                return (jsxRuntimeExports.jsx(reactBootstrap.Nav.Link, { onClick: () => handleNavigate(item.path), className: "nav-item nav-regular-link", children: item.title }, index));
                            }
                            return null;
                        }) }) })] }) }));
};
...
function requireReactIs$1 () {
	...
	if (process.env.NODE_ENV === 'production') {
	  reactIs$1.exports = requireReactIs_production$1();
	} else {
...
var MoreVertIcon = createSvgIcon(/*#__PURE__*/jsxRuntimeExports.jsx("path", {
  d: "M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2m0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2m0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2"
}), 'MoreVert');

var logo_erc = "assets/logo_erc.png";

var logo_reichman_university = "assets/logo_reichman_university.png";

var logo_uni_hamburg = "assets/logo_uni_hamburg.png";
...
const OutlinedInput = /*#__PURE__*/React__namespace.forwardRef(function OutlinedInput(inProps, ref) {
  ...
  const [NotchedSlot, notchedProps] = useSlot('notchedOutline', {
    ...
    additionalProps: {
      label: label != null && label !== '' && fcs.required ? /*#__PURE__*/jsxRuntimeExports.jsxs(React__namespace.Fragment, {
        children: [label, "\u2009", '*']
      }) : label
    }
  });
...
var SearchIcon = createSvgIcon(/*#__PURE__*/jsxRuntimeExports.jsx("path", {
...
function useAutocomplete(props) {
  ...
  const [focusedItem, setFocusedItem] = React__namespace.useState(-1);
  ...
  const initialInputValue = React__namespace.useRef(getInputValue(defaultValue ?? valueProp, multiple, getOptionLabel)).current;
  const [value, setValueState] = useControlled({
    controlled: valueProp,
    default: defaultValue,
    name: componentName
  ...
  const [focused, setFocused] = React__namespace.useState(false);
  const resetInputValue = React__namespace.useCallback((event, newValue, reason) => {
...
var CheckIcon = createSvgIcon(/*#__PURE__*/jsxRuntimeExports.jsx("path", {
...
exports.MultiSelectCollections = MultiSelectCollections;
